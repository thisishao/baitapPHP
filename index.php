								...
								<div class="single-products">
										...
										<div class="product-overlay">
											...
											<form method="POST">
												...
												<input type="hidden" name="name" value="Shirt 1">
												<button class="btn btn-default add-to-cart" name="sub"><i class="fa fa-shopping-cart"></i>Add to cart</button>
											</form>
									...
									<div class="product-overlay">
										<div class="overlay-content">
											...
											<form method="POST">
												...
												<input type="hidden" name="name" value="Shirt 2">
												<button class="btn btn-default add-to-cart" name="sub"><i class="fa fa-shopping-cart"></i>Add to cart</button>
											</form>
										</div>
									</div>
									...
									<div class="product-overlay">
										<div class="overlay-content">
											...
											<form method="POST">
												...
												<input type="hidden" name="name" value="Shirt 3">
												<button class="btn btn-default add-to-cart" name="sub"><i class="fa fa-shopping-cart"></i>Add to cart</button>
											</form>
										</div>
									</div>
									...
									<div class="product-overlay">
										<div class="overlay-content">
											<form method="POST">
												...
												<input type="hidden" name="name" value="Shirt 4">
												<button class="btn btn-default add-to-cart" name="sub"><i class="fa fa-shopping-cart"></i>Add to cart</button>
											</form>
										</div>
									</div>
									...
									<div class="product-overlay">
										<div class="overlay-content">
											...
											<form method="POST">
												...
												<input type="hidden" name="name" value="Shirt 5">
												<button class="btn btn-default add-to-cart" name="sub"><i class="fa fa-shopping-cart"></i>Add to cart</button>
											</form>
										</div>
									</div>
									...
									<div class="product-overlay">
										<div class="overlay-content">
											...
											<form method="POST">
												...
												<input type="hidden" name="name" value="Shirt 6">
												<button class="btn btn-default add-to-cart" name="sub"><i class="fa fa-shopping-cart"></i>Add to cart</button>
											</form>
										</div>
									</div>
